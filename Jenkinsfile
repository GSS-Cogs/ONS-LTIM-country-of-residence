pipeline {
    ...
    stages {
        ...
        stage('Transform') {
            ...
            steps {
                sh "jupyter-nbconvert --output-dir=out --ExecutePreprocessor.timeout=None --execute 'Long-term international migration 2.02 next or last residence tidydata.ipynb'"
            }
        }
